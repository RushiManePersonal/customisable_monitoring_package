# monitoring/stat_tests/psi_test.py
...
class PSITest:
    ...
    def run(self, reference_data, current_data, threshold=0.2, n_bins=10, plot=False, **kwargs):
        ...
        psi_value, ref_perc, curr_perc, bins_or_cats = _calculate_psi_and_bins(
        ...
        result = {
            ...
            'plot_data': plot_data # CRITICAL: Include the plot_data package
        }
